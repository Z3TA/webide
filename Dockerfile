...
# 
# if we got Nginx to work: (would need dedicated IP inside cloud ide, todo: give each user their own IPv6 and allow tcp/udp)
...
# node nodejs_init.js --trace-deprecation -insidedocker -domain d80.johan.webide.se &
#
