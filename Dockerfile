...
#
# Before running tests: Run ssh-keygen in the *webide* terminal (not docker) and cat /home/ltest1/.ssh/id_rsa.pub - then add the ssh public key to the Github test account
#
