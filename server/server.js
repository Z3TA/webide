...
var CLOU_IDE = getArg(["cloudide", "cloudide"]); // Should be the "fake" TLD... Faking that we are running as a cloud ide, useful when testing
//console.log("CLOU_IDE=" + CLOU_IDE);
						...
						function acceptUser() {
							...
							*/
							...
							var userClientInfo = {
								...
								tld: (!USERNAME || CLOU_IDE) && (CLOU_IDE || DOMAIN)
							};
