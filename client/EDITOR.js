				...
				EDITOR.getFileSizeOnDisk(path, function gotFileSize(err, fileSizeInBytes) {
					...
					if(err) {
						...
						if(fileSizeInBytes > EDITOR.settings.bigFileSize) {
							...
							//return fileOpenError(new Error("Opening large files not yet supported in the browser!"));
