...
return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")
	}function a(e,...t){const n=Object.create(null);for(let t in e)n[t]=e[t]
		;return t.forEach((e=>{for(let t in e)n[t]=e[t]})),n}const i=e=>!!e.kind
...
const t=e[0],n=e.rule,r=new s(n),a=[n.__beforeBegin,n["on:begin"]]
				;for(let n of a)if(n&&(n(e,r),r.ignore))return b(t)
...
autoDetection:O,inherit:K,addPlugin:e=>{a.push(e)},vuePlugin:S(e).VuePlugin
	...
	;for(let e in R)"object"==typeof R[e]&&t(R[e])
...
endsParent:!0,keywords:[...l,...o],contains:[U]}]};for(let e of K.variants){
