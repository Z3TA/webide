...
return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")
	}function a(e,...t){const n=Object.create(null);for(var t in e)n[t]=e[t]
		;return t.forEach((e=>{for(var t in e)n[t]=e[t]})),n}const i=e=>!!e.kind
...
autoDetection:O,inherit:K,addPlugin:e=>{a.push(e)},vuePlugin:S(e).VuePlugin
	...
	;for(var e in R)"object"==typeof R[e]&&t(R[e])
