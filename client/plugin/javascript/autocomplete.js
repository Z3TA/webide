		...
		*/
		...
		function figureOutParameterType(fun, autocompleteArgumentIndex, charIndex, js) {
			...
			function analyzeExpression(str, index) {
				...
				//else {console.log("analyzeExpression: Unable to find variable " + str + " in scope=" + JSON.stringify(scope, null, 2));}
			...
			if(properties.length > 1) {
				...
				if(variables.hasOwnProperty(properties[0])) {
					...
					if(variable.hasOwnProperty("keys")) {
						...
						//else {console.log("searchVariables: Variable " + properties[propertyIndex-1] + " already have " +  Object.keys(variable.keys).length + " keys!");}
		...
		function figureOutVariableType(value, charIndex, js, addKeysToVariable) {
			...
			if(!func) {
				...
				//else {console.log("figureOutVariableType: " + props[0] + " is a variable! type=" +variable.type);}
				...
				if(!theFunction) {
					...
					if(property[0] == "this") {
						...
						*/
						...
						//else {console.warn("There is no function called " + functionName + " in current scope!");}
