...
if(CHROMEBOOK) {
		EDITOR.bindKey({desc: S("find_replace"), key: "Meta", combo: CTRL, fun: findReplaceViaChromebookSearch});
		}
		...
		EDITOR.registerAltKey({char: "f", alt:1, label: S("find"), fun: findReplace});
