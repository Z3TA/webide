	...
	*/
	...
	EDITOR.plugin({
		...
		load:function devModeLoad() {
			...
			winMenuReloadEditor = EDITOR.windowMenu.add(S("Restart"), [S("Editor"), 11], reloadEditor);
			winMenuToggleDevMode = EDITOR.windowMenu.add(S("developer_mode"), [S("Editor"), "Debug", 9], toggleDevMode);
