/*
	...
	This was abandoned because it "locked" some thread, so we couln't save files while the spellchecker was loading.
...
var programmersAbbr = ["str", "num"];
		...
		if(htmlTags.indexOf(word) != -1 || jsKeywords.indexOf(word) != -1 || isNumeric(word) || programmersAbbr.indexOf(word) != -1 || fileExtensions.indexOf(word) != -1) {
			...
			*/
			...
			/*
				Problem: cant save file while running the spellcheck!
				Tried setTimeout, but it didn't help. Will try webWorers next ...
			*/
